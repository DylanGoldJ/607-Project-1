...
get_avg_opp_rating <- function(opponents){ #I just loop through, probably better dplyr functions
...
```
TODO, check an example with null elements, convert to csv after selecting the right columns